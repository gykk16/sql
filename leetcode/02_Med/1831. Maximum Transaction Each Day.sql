...
SELECT TO_CHAR(DAY, 'YYYYMMDD') AS "DAY"
       ,MAX(AMOUNT) AS MAX_VAL
  FROM TRANSACTIONS T
 GROUP BY TO_CHAR(DAY, 'YYYYMMDD');
...
SELECT T.TRANSACTION_ID
  FROM TRANSACTIONS T
      ,(SELECT TO_CHAR(DAY, 'YYYYMMDD') AS "DAY"
               ,MAX(AMOUNT) AS MAX_VAL
          FROM TRANSACTIONS T
         GROUP BY TO_CHAR(DAY, 'YYYYMMDD')) TAB_A
 WHERE TO_CHAR(T.DAY, 'YYYYMMDD') = TAB_A.DAY
       AND T.AMOUNT = TAB_A.MAX_VAL
